"""One-off: migrate the Arden semi sheet's products into the Full-auto
sheet (2026-08-10). For every semi row whose SKU has a LIVE listing on the
Arden OnBuy account, append a Full-sheet row carrying SKU + Supplier URL +
...
FULL_SHEET = "Arden_Full_Feed_Master"
