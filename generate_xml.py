...
EBAY_DAILY_CALL_BUDGET = int(os.getenv("EBAY_DAILY_CALL_BUDGET") or "3000")
...
# 2026-09-14). Each tab has its own workflow; FEED_FILE keeps their feed
# uploads apart.
...
# sentence on the row. Arden rows 4008-4017 sat blocked for weeks on
# brands ("Metatell", "OnlineBull", "Unbranded") the platform was
# accepting on neighbouring rows the whole time: the verdict was re-read
...
def main():
    ...
    spreadsheet = with_retry(lambda: client.open("Arden_Full_Feed_Master"),
